...
brew "ouch"              # compress/decompress archives
brew "tokei"             # code statistics by language
brew "scc"               # fast code counter (tokei alt)
brew "onefetch"          # git repo summary in terminal
...
cask "font-jetbrains-mono-nerd-font" # patched dev font with icons
cask "ghostty"           # GPU-accelerated terminal
cask "hiddenbar"         # hide menu bar icons
cask "rectangle"         # window snapping via keyboard
