...
complete -c ai-agent -n __fish_ai_agent_needs_command -a focus -d "Focus an agent's herdr workspace"
...
complete -c ai-agent -n '__fish_ai_agent_seen_command focus' -xa '(__fish_ai_agent_slugs)' -d 'Agent slug'
