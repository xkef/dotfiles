...
complete -c dots -n __fish_use_subcommand -xa lock -d 'Record the live nvim plugin lockfiles in the repo'
...
complete -c dots -n '__fish_seen_subcommand_from theme' -xa "(theme --completions 2>/dev/null)"
