<!-- Generated by ai-base/.local/bin/ai-agents-render. Do not edit by hand.
     Edit ai-base/.config/ai-shared/AGENTS.base.md or overlays/<tool>.append.md instead. -->
...
nono profile also allows `~/.pi/agent/` and the
